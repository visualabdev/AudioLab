    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-24 pb-32">
        <div className="container mx-auto px-4">
          ...
          <div className="relative mb-12 overflow-hidden rounded-3xl bg-gradient-to-br from-pink-500/10 via-purple-500/10 to-pink-600/10 p-12 border border-pink-500/20">
            ...
            <div className="relative z-10 space-y-6">
              <div className="flex items-center gap-3">
                <div className="p-3 rounded-xl bg-pink-500/20 backdrop-blur-sm border border-pink-500/30">
                  <FileMusic className="w-8 h-8 text-pink-400" />
                </div>
              ...
              <p className="text-xl text-muted-foreground max-w-3xl text-balance">
                Archivos MIDI profesionales para acelerar tu workflow. Melodías, progresiones de acordes, basslines y
                más, listos para personalizar con tus propios sonidos.
              </p>
              <div className="flex flex-wrap gap-4 text-sm">
                <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-pink-500/10 border border-pink-500/20">
                  <Music className="w-4 h-4 text-pink-400" />
                  <span className="text-pink-300">{midiTracks.length} Archivos MIDI</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-pink-500/10 border border-pink-500/20">
                  <span className="text-pink-300">100% Editable</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-pink-500/10 border border-pink-500/20">
                  <span className="text-pink-300">Compatible con todos los DAWs</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            <p className="text-sm text-muted-foreground">
              Mostrando {filteredTracks.length} {filteredTracks.length === 1 ? "archivo" : "archivos"}
            </p>
          </div>
          ...
          {filteredTracks.length > 0 ? (
            ...
            <div className="text-center py-16">
              <p className="text-lg text-muted-foreground">No se encontraron archivos con estos filtros</p>
            </div>
          )}
        </div>
      </main>
